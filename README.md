...
**読みは合成の前に総ざらいする。**
`python tools/readings.py suspects <ep_dir>` で台詞中の漢字語を全部さらい、
読みを並べて人が目で拾う。第002回では 208 語のうち 8 つが誤読だった
（思案橋→シアンキョウ、袋橋→フクロキョウ、桃渓橋→モモ・ケエキョウ、
風頭山→カザガシラサン、浜町→ハマチョウ、魚の町→サカナノマチ ほか）。
